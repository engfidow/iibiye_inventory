...
const UpdateProfile = ({ user, setUser, isOpen, onRequestClose }) => {
  ...
  const [imagePreview, setImagePreview] = useState(user?.image ? `https://iibiye-inventory.onrender.com/${user.image}` : "path/to/default/avatar.png");
  ...
  useEffect(() => {
    ...
    setImagePreview(user?.image ? `https://iibiye-inventory.onrender.com/${user.image}` : "path/to/default/avatar.png");
  }, [user]);
