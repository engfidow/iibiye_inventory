...
function Login({ setUser }) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post('https://iibiye-inventory.onrender.com/api/users/signup', formDataWithDefaults);

      // Auto-login after successful registration
      const loginResponse = await axios.post('https://iibiye-inventory.onrender.com/api/users/login', {
  ...
  const handleFormSubmitLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://iibiye-inventory.onrender.com/api/users/login', formLoginData);
  ...
  const handleResetPasswordRequest = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://iibiye-inventory.onrender.com/api/users/send-verification-code', { email: resetEmail });
  ...
  const handleUpdatePassword = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post('https://iibiye-inventory.onrender.com/api/users/update-password', {
        email: resetEmail,
  ...
  const showAdminContact = async () => {
    try {
      const response = await axios.get('https://iibiye-inventory.onrender.com/api/users/getAdmin/Contact');
